...
function testCollision( g ) {
    ...
    circle1.draw( globalThis.canvas.context );

    const cx2 = 144;
    const cy2 = 277;
    const circle2 = new Circle( cx2, cy2, 88 );
    circle2.draw( globalThis.canvas.context );

    const line1 = new Line( 30, 300, 300, 30 );
    line1.draw( globalThis.canvas.context );
    line1.drawPLineByPoint( globalThis.canvas.context, cx1, cy1, 'blue' );
    line1.drawPLineByPoint( globalThis.canvas.context, cx2, cy2, 'red' );
